...
class ListadoProductos extends Component {
    ...
    peticionGet = () => {
        Axios.get(`${apiBaseUrl}/get-products`).then(response => {
    ...
    peticionDelete = (id) => {
        Axios.delete( `${apiBaseUrl}/delete-product/` + id).then(response => {
        ...
        return (
            <div className="container">
                                            ...
                                            <th scope="row">{producto.id}</th>
                                                ...
                                                <td>
                                                    <div className="btn-group d-flex justify-content-center" role="group">
                                                        ...
                                                        onClick={()=>{this.seleccionarProducto(producto); this.setState({modalEliminar: true})}}><img src={Eliminar} className="img-small-table"
                                                            alt="Busqueda" /></button>
                                                    </div>
                                                </td>
                                            </tr>
                ...
                <Modal isOpen={this.state.modalEliminar}>
                    <ModalBody>
                        Estás seguro que deseas eliminar el producto {this.state.producto.id && this.state.producto.nombre}
                    </ModalBody>
                    <ModalFooter>
